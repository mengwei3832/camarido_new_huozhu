...
/**
 * 
 * @Description:class 输入支付密码页面
 * @ClassName: InputPasswordActivity
 * @author: zhm
 * @date: 2016-4-14 上午10:33:35
 * 
 */
public class InputPasswordActivity extends BaseActivity implements
	...
	protected void initData() {
		...
		Log.e("TAG", "进入密码的页面----------进行GRIDVIEW的布局--------------");
		// 实例化键盘集合
		...
		// 对GridView的监听
		gAdapter = new GridViewKeybroadAdapter(list, InputPasswordActivity.this);
	...
	protected void setListener() {
		...
		Log.e("TAG", "进入密码的页面----------进行GRIDVIEW的点击监听--------------");
		// 设置密码成功的监听
	...
	private void uploadPayPass() {
		...
		// TODO
		httpPost(new UploadPassRequest(InputPasswordActivity.this, md5Password));
		// 设置完成按钮不可点击
	...
	public void onSuccess(int requestId, Response response) {
		...
		if (isSuccess) {
			...
			ResetPassActivity.invoke(InputPasswordActivity.this);
			InputPasswordActivity.this.finish();
		} else {
	...
	public static void invoke(Activity activity) {
		Intent intent = new Intent(activity, InputPasswordActivity.class);
