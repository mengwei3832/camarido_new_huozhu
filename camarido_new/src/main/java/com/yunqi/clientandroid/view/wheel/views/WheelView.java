...
package com.yunqi.clientandroid.view.wheel.views;
...
import com.yunqi.clientandroid.view.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xeeffffff,
			0xeaffffff, 0x33ffffff };
