 ...
 * @Copyright (c) 2015
 * @Description class 获取当前运单列表接口
 * @date 15/12/3
 */

public class GetExecutingTicketListRequest extends IRequest {

	public GetExecutingTicketListRequest(Context context, int pageSize,
			int pageIndex) {
		super(context);
		// 传参
	...
	public String getUrl() {
		return getHost() + "api/Ticket/GetExecutingTicketList";
	}
