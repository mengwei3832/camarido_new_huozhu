...
public class GetSignTicketAgainRequest extends IRequest {

	public GetSignTicketAgainRequest(Context context, String ticketId,
	...
	public String getUrl() {
		return getHost() + "api/Ticket/SignTicketAgain";
	}
