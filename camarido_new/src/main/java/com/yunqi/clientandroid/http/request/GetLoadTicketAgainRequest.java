...
public class GetLoadTicketAgainRequest extends IRequest {

	public GetLoadTicketAgainRequest(Context context, String ticketId,
	...
	public String getUrl() {
		return getHost() + "api/Ticket/LoadTicketAgain";
	}
