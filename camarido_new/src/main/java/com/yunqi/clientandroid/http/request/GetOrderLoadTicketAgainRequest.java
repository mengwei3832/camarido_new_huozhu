 ...
 * @Copyright (c) 2015
 * @Description class 重新上传装货单接口
 * @date 15/12/21
 */

public class GetOrderLoadTicketAgainRequest extends IRequest {

	public GetOrderLoadTicketAgainRequest(Context context, String ticketId,
	...
	public String getUrl() {
		return getHost() + "api/ProviderTicket/LoadTicketAgain";
	}
