...
/**
 * @Description:class 历史订单的请求类
 * @ClassName: TicketAllCurrentRequest
 * @author: mengwei
 * @date: 2016-6-12 下午3:05:43
 * 
 */
public class TicketHistoryCurrentRequest extends IRequest {

	public TicketHistoryCurrentRequest(Context context, int pageSize,
	...
	public String getUrl() {
		return getHost() + "pkgapi/Ticket/GetExecutedTicket";
	}
