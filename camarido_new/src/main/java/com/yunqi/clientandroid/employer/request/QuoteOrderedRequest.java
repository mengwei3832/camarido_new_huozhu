...
/**
 * @Description:已下单的报价单请求
 * @ClassName: QuoteAllOrderRequest
 * @author: mengwei
 * @date: 2016-6-29 下午2:14:18
 * 
 */
public class QuoteOrderedRequest extends IRequest {

	public QuoteOrderedRequest(Context context, int PageIndex, int PageSize,
			String packageId) {
		super(context);
		// 传参
	...
	public String getUrl() {
		return getHost() + "pkgapi/Package/GetOrderPartInforByPakcage";
	}
