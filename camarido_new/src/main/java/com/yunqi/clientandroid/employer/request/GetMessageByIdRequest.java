 ...
 * 
 */
public class GetMessageByIdRequest extends IRequest {
	private String id;

	public GetMessageByIdRequest(Context context, String id) {
		super(context);
		this.id = id;
		mParams.put("id", id);
	}
	...
	public String getUrl() {
		return getHost() + "pkgapi/Message/GetMessageById/" + id;
	}
