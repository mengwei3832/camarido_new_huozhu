 ...
 * 
 */
public class HangYeLieBiaoActivity extends BaseActivity implements
	...
	private void initActionBar() {
		...
		setOnActionBarLeftClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// 关闭当前的Activity页面
				HangYeLieBiaoActivity.this.finish();
			}
		});
	...
	private void getZiXunLieBiao() {
		...
		httpPost(new HangYeRequest(mContext, pageSize, pageIndex, tagId));
	}
	 ...
	 * 本界面invoke跳转方法
	 */
	public static void invoke(Context context, String title, int tagId) {
		Intent intent = new Intent(context, HangYeLieBiaoActivity.class);
