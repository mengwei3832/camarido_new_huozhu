...
/**
 * @Description:class 全部订单的请求类
 * @ClassName: TicketAllCurrentRequest
 * @author: mengwei
 * @date: 2016-6-12 下午3:05:43
 * 
 */
public class TicketAllCurrentRequest extends IRequest {

	public TicketAllCurrentRequest(Context context, int pageSize,
	...
	public String getUrl() {
		return getHost() + "pkgapi/Ticket/GetTicket";
	}
