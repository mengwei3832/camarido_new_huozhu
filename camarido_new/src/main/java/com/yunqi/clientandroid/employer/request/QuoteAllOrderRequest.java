...
/**
 * @Description:全部的报价单请求
 * @ClassName: QuoteAllOrderRequest
 * @author: chengtao
 * @date: 2016-6-29 下午2:14:18
 * 
 */
public class QuoteAllOrderRequest extends IRequest {

	public QuoteAllOrderRequest(Context context, int PageIndex, int PageSize,
			String packageId) {
		super(context);
		// 传参
	...
	public String getUrl() {
		return getHost() + "pkgapi/Package/GetPartInforByPakcage";
	}
