...
/**
 * @Description:历史的报价单请求
 * @ClassName: QuoteAllOrderRequest
 * @author: chengtao
 * @date: 2016-6-29 下午2:14:18
 * 
 */
public class QuoteHistoryOrderRequest extends IRequest {

	public QuoteHistoryOrderRequest(Context context, int PageIndex,
	...
	public String getUrl() {
		return getHost() + "pkgapi/Package/GetHistoryPartInforByPakcage";
	}
