...
public class CaptureActivity extends Activity {
    ...
    private static final String EXTRA_RESULT_CALLBACK = "RESULT_CALLBACK";
...
//	}
     ...
     * 跳转方法
     */
    public static void invoke(Context context, IResultCallBack listener) {
        mResultCallBack = listener;
